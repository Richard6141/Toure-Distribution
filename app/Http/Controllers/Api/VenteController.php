...
class VenteController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'details.*.required' => 'Chaque détail de vente est requis',
            ...
            'details.*.quantite.required' => 'La quantité est requise pour chaque produit',
            'details.*.quantite.min' => 'La quantité doit être au moins 1',
            'details.*.prix_unitaire.required' => 'Le prix unitaire est requis pour chaque produit',
